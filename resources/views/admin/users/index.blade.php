            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-2xl sm:rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-xl font-bold uppercase tracking-wide">User List</h3>
                        <div class="flex space-x-2">
                             <form action="{{ route('admin.users.index') }}" method="GET" class="flex items-center">
                                <input type="text" name="search" placeholder="Search users..." value="{{ request('search') }}" class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 mr-2">
                        ...
                        <table class="w-full max-w-6xl leading-normal text-center table-fixed">
                            <thead>
                                <tr class="bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 uppercase text-sm leading-normal">
                                    ...
                                    <th class="py-3 px-6 text-center w-32">Role</th>
                                    <th class="py-3 px-6 text-center w-40">Created At</th>
                            ...
                            <tbody class="text-gray-600 dark:text-gray-200 text-sm font-light">
                                @foreach($users as $user)
                                    <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600">
                                        ...
                                        <td class="py-3 px-6 text-center align-middle">
                                            @if($user->role === 'admin')
                                                <span class="bg-red-200 text-red-600 py-1 px-3 rounded-full text-xs font-bold uppercase">
                                                    Admin
                                                </span>
                                            @else
                                                <span class="bg-green-200 text-green-600 py-1 px-3 rounded-full text-xs font-bold uppercase">
                                                    User
                                                </span>
                                            @endif
                                        </td>
                                        ...
                                        <td class="py-3 px-6 text-center align-middle">
                                            <div class="flex item-center justify-center space-x-4">
                                                <a href="{{ route('admin.users.edit', $user) }}" class="text-yellow-500 hover:text-yellow-600 transform hover:scale-125 transition" title="Edit">
